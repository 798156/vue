          ...
          <v-list aria-label="title" aria-busy="true">
            <v-list-item class="d-sm-flex d-block">
              <template v-slot:title>
                <h5 class="text-subtitle-1 mt-1 mb-3 mb-sm-0">付款方式</h5>
              </template>
              <template v-slot:append>
                <v-btn size="small" color="primary" variant="flat" class="ml-2">添加新的付款方式</v-btn>
              </template>
            </v-list-item>
          </v-list>
          <v-divider></v-divider>
                ...
                <v-list-item>
                  ...
                  <template v-slot:append>
                    <div class="d-sm-flex align-center mt-3">
                      <v-chip color="primary" label size="small" variant="tonal" v-if="method.default">默认</v-chip>
                      <v-chip color="secondary" label size="small" variant="tonal" v-else> 设为默认 </v-chip>
                      <v-divider vertical class="mx-4" inset style="height: 20px"></v-divider>
                      <v-btn size="small" variant="flat" color="primary">进入</v-btn>
                    </div>
                  </template>
                </v-list-item>
