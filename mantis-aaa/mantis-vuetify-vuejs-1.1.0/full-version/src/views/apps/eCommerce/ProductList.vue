...
const headers: Header[] = [
  { text: '商品详情', value: 'image' },
  { text: '商品名称', value: 'name', sortable: true },
  { text: '生产日期', value: 'created', sortable: true },
  { text: '原价', value: 'offerPrice', sortable: true },
  { text: '售价', value: 'salePrice', sortable: true },
  { text: '有货/售罄', value: 'isStock' },
        ...
        <v-card-text class="pa-0">
          ...
          >
            ...
            <template #item-isStock="{ isStock }">
              <div class="player-wrapper">
                <v-chip color="success" v-if="isStock" size="small" label> 有货 </v-chip>
                <v-chip color="error" v-else size="small" label> 售罄 </v-chip>
              </div>
            </template>
