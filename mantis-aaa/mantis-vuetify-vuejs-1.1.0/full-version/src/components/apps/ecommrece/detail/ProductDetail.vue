      ...
      <v-col md="6" sm="12" cols="12">
        <div class="d-flex align-top">
          <div>
            ...
            <v-chip color="success" size="small" label v-if="getProduct.isStock"> 有货 </v-chip>
            <v-chip color="error" size="small" label v-else> 售罄 </v-chip>
          </div>
        </div>
        ...
        <v-row>
          <v-col lg="12" cols="12">
            <table class="productCustomize">
              <tr>
                <!-- <td class="text-lightText pl-0">颜色</td>
                <td>
              ...
              <tr>
                <td class="text-lightText pl-0">数量</td>
                <td>
            ...
            <div class="d-flex align-end ga-2 mb-3">
              ...
              <small class="text-medium-emphasis">(折后价)</small>
            </div>
          </v-col>
          <v-col lg="6">
          ...
          <v-col lg="6">
            <v-btn block color="secondary" size="large" variant="outlined" @click="store.AddToCart(getProduct)">添加购物车</v-btn>
          </v-col>
        </v-row>
      </v-col>
    </v-row>
