...
// icons
import { SearchOutlined, EyeOutlined, EditOutlined, CopyOutlined, PrinterOutlined, FilterOutlined } from '@ant-design/icons-vue';
        ...
        <v-card-text class="pa-0">
          ...
          >
            ...
            <template #item-status="{ status }">
              <v-chip color="success" v-if="status === 1" size="small" label> Complete </v-chip>
              <v-chip color="error" v-if="status === 2" size="small" label> Processing </v-chip>
              <v-chip color="primary" v-if="status === 3" size="small" label> Confirm </v-chip>
            </template>
            <template #item-operation>
              <div class="operation-wrapper">
                ...
                <v-btn icon color="primary" variant="text" rounded @click="Rdialog.dialog = true">
                  <EditOutlined />
                </v-btn>
              </div>
            </template>
