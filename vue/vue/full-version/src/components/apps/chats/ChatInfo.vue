  ...
  <div v-if="chatDetail" class="customHeight pa-4">
    ...
    <div class="py-4">
      ...
      <div class="d-flex ga-4 mt-6">
        <div class="bg-lightprimary w-100 pa-4 rounded-lg">
          <h6 class="text-h6 text-primary mb-0">所有文件</h6>
    ...
    <v-expansion-panels v-model="panel1" class="accordionWithoutBorder mt-2">
      <v-expansion-panel elevation="0">
        <v-expansion-panel-title class="text-h5 pa-0 pb-3" color="surface">信息</v-expansion-panel-title>
        <v-expansion-panel-text>
          <v-list density="compact" class="pa-0" aria-label="information list" aria-busy="true" nav>
            <v-list-item class="pa-0">
              <div class="d-flex">
                <p class="mb-0 text-h6">地址</p>
                <p class="mb-0 text-h6 text-lightText ml-auto">浙江*杭州</p>
              </div>
            </v-list-item>
            <v-list-item class="pa-0">
              <div class="d-flex">
                <p class="mb-0 text-h6">邮箱</p>
                <p class="mb-0 text-h6 text-lightText ml-auto">1412118291@qq.com</p>
              </div>
            </v-list-item>
            <v-list-item class="pa-0">
              <div class="d-flex">
                <p class="mb-0 text-h6">电话号码</p>
                <p class="mb-0 text-h6 text-lightText ml-auto">13750822419</p>
              </div>
            </v-list-item>
            <v-list-item class="pa-0">
              <div class="d-flex">
                <p class="mb-0 text-h6">上一次浏览</p>
